...
const SessionView: React.FC = () => {
    ...
    const [pulseParticipant, setPulseParticipant] = useState(false);
                ...
                if (sessionRes.success) {
                    ...
                    socketService.onUserJoined((newUser: any) => {
                        ...
                        setSession((prev) => {
                            ...
                            setPulseParticipant(true);
                            setTimeout(() => setPulseParticipant(false), 500);
                        ...
                        setToast({ message: `${newUser.name} joined the session!`, type: "info" });
                    });
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "1.5rem" }}>
                    ...
                    {user?.role?.toLowerCase() === "teacher" ? (
                        ...
                        <div style={{ display: "flex", gap: "0.75rem" }}>
                            <button
                                onClick={() =>
                                    socketService.emitEmojiReaction(code || "", "🤔", user)
                                }
                                className="btn btn-secondary"
                                style={{
                                    background: "rgba(245, 158, 11, 0.1)",
                                ...
                                title="Signal that you are lost or confused"
                            >
                                I'm Lost
                            </button>
                            <button
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        >
                            Question{" "}
                            {sortedQuestions.findIndex((q) => q._id === selectedQuestionId) + 1} of{" "}
                            {questions.length}
                        </div>
                ...
                >
                    ...
                    <div style={{ flex: 1, overflowY: "auto", paddingRight: "0.5rem" }}>
                        ...
                        >
                            <h4 className={`mb-2 ${pulseParticipant ? "pulse-animation" : ""}`}>
            ...
            {showEndModal && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            This will stop all submissions and generate a final report. This action
                            cannot be undone.
                        </p>
            ...
            {pulseCheckActive && user?.role?.toLowerCase() === "student" && (
                ...
                >
                    ...
                    >
                        ...
                        <h2 style={{ marginBottom: "0.5rem", color: "var(--color-warning)" }}>
                            WAKE UP!
                        </h2>
                        <p
                            style={{
