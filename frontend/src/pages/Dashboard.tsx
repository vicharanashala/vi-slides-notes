...
const Dashboard: React.FC = () => {
  ...
  const handleCreateSession = async (e: React.FormEvent) => {
    e.preventDefault();
    console.log("createSession button clicked", sessionTitle);
    if (!sessionTitle.trim()) return;

    setError("");
    try {
      console.log("About to call createSession API");
    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Failed to join session. Please check the code.",
      );
    }
  };
    ...
    <div style={{ minHeight: "100vh", background: "var(--color-bg)" }}>
          ...
          {showUserMenu && (
            <div
              ...
              style={{
                ...
                boxShadow:
                  "0 20px 25px -5px rgba(0, 0, 0, 0.5), 0 0 15px rgba(99, 102, 241, 0.3)",
              }}
            >
              <div
                style={{
      ...
      <main className="container fade-in" style={{ paddingTop: "3rem" }}>
        <div className="glass-card" style={{ marginBottom: "2rem" }}>
          ...
          {error && (
            <div
              className="alert alert-error slide-in"
          ...
          {user?.role?.toLowerCase() === "teacher" ? (
            <>
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(20, 184, 166, 0.1) 0%, rgba(20, 184, 166, 0) 100%)",
                }}
              >
                <h3>📚 Assignments</h3>
                <p className="text-muted mt-1">
            ...
            <>
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(255, 215, 0, 0.1) 0%, rgba(255, 215, 0, 0) 100%)",
                }}
              >
                <h3>🎓 Certificates</h3>
                <p className="text-muted mt-1">
        ...
        {showCertModal && (
          ...
          >
            ...
            >
              ...
              {pastSessions.filter(
                (session) => !hiddenCerts.includes(session._id),
              ).length === 0 ? (
                <p className="text-muted">
                  No certificates found. Join sessions to earn them!
                </p>
              ) : (
                <div
                  style={{
        ...
        >
          ...
          >
            ...
            {activeSession.qrCodeDataUrl ? (
              ...
              >
                <img
                  src={activeSession.qrCodeDataUrl}
                  alt="QR Code"
