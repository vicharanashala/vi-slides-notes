...
const s: Record<string, React.CSSProperties> = {
  ...
  joinBtn: { width: "100%", background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", color: "#fff", border: "none", borderRadius: "12px", padding: "16px", fontSize: "16px", fontWeight: 700, cursor: "pointer", boxShadow: "0 4px 15px rgba(102,126,234,0.4)" },
  ...
  submitBtn: { width: "100%", background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", color: "#fff", border: "none", borderRadius: "12px", padding: "14px", fontSize: "15px", fontWeight: 700, cursor: "pointer", boxShadow: "0 4px 15px rgba(102,126,234,0.4)" },
  ...
  studentAvatar: { width: "48px", height: "48px", borderRadius: "50%", background: "linear-gradient(135deg, #667eea 0%, #764ba2 100%)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800, fontSize: "20px" },
  ...
  questionItemNum: { background: "#667eea", color: "#fff", borderRadius: "8px", padding: "4px 10px", fontSize: "12px", fontWeight: 800 },
